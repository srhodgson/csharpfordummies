...
// AlignOutput -- Left justify and align a set of strings to improve the appearance 
// of program output.
...
namespace AlignOutput
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // This time, fix the strings so that they are left justified and all
            // the same length.

            // First, copy the source list into a new list that you can manipulate 
            ...
            // Now find the length of the longest string so that all other strings
            // lin up with that string 
            int maxLength = 0;
            ...
            Console.WriteLine("The following are the same names normalised as the same length.");
