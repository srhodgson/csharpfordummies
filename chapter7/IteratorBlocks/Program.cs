...
namespace IteratorBlocks
{
    ...
    {
        // Main -- Demonstrate five different applications of iterator blocks.
        static void Main(string[] args)
        {
            ...
            // Iterate it: produce one double at a time
    ...
    // MonthDays -- Define an iterator that returns the months and their lengths in days -- sort of a collection class
    class MonthDays
    {
        // Heres the collection
        string[] months = { "January 31", "February 28", "March 31", "April 30",
                            "May 31", "June 30", "July 31", "August 31", "September 30",
                            "October 31", "November 30", "December 31" };

        // GetEnumerator -- Here's the iterator. See how it is invoked
    ...
    // StringChunks -- Define an iterator that returns chunks of text, one per iteration 
    ...
    // YieldBreak -- Another example of the yield break keyword 
    class YieldBreakEx
    {
    ...
    // fro mthe top value you pass is DOWN to the stop value another 
    // oddball collection class.
    class EvenNumbers
    {
        // DescendingEvens -- This is a named iterator 
        // also demonstrates the yield break keyword 
        // see how its involved in Main() with foreach 
        public System.Collections.IEnumerable DescendingEvens(int top, int stop)
        {
            ...
            // Iterator from top down to nearest even above stop
    ...
    // PropertyIterator -- Demonstrate implementing a class property's get accessor 
    // and an iterator block.
