 ...
 * Demonstrate how you can replace the c# default constructor with your own,
 * custom constructor. Creates a class with a constructor and then steps through
 * a few scenarios.
 */

namespace DemonstrateCustomConstructor
{
    // MyObject -- Create a class with a noisy custom constructor and an
    ...
    // MyOtherObject -- This class also has a noisy constructor but no internal
    // members.
