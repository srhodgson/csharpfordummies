...
/*
 * BankAccount
 * Create a bank account using a double variable to store the account balance 
 * (keep the balance in a private variable to hide its implementation from the
 * outside world).
 * Note: Untilyou correct it, this program fails to compile because Main() refers
 * to a private member of class BankAccount
 */
...
namespace BankAccount
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Accessing the balance via Deposit() method is okay 
    ...
    public class BankAccount
    {
        ...
        // Init -- Initialise a bank account with the next account id 
        // and a balance of 0
        ...
        // GetString -- return account data as a string 
