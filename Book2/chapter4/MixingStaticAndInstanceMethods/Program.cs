...
/*
 * MixingStaticAndInstanceMethods
 * Mixing class (static) methods and instance (nonstatic) methods can cause
 */
...
namespace MixingStaticAndInstanceMethods
{
    public class Student
    {
        ...
        // InitStudent -- Initialise the student object.
        ...
        {
            // The class Student is implied but no this object is passed to the 
            // static method.
            OutputBanner();
        ...
        {
            // Here, the current object is implicit -- this could have been 
            // written: return this._firstName + " " + this._lastName;
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            student.InitStudent("Stephen", "Hodgson");
